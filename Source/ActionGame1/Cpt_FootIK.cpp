...
void UCpt_FootIK::Set_IKSocketName(FString sSocName_LeftFoot, FString sSocName_RightFoot)
{
...
void UCpt_FootIK::IK_Update(float fDeltaTime)
{
...
void UCpt_FootIK::SetIKDebug(bool bActive)
{
	m_bDebug = bActive;
}
